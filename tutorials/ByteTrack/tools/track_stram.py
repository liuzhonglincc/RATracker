...
def make_parser():
    ...
    # tracking args
    parser.add_argument("--track_thresh", type=float, default=0.58, help="tracking confidence threshold")
    ...
    parser.add_argument('--weight_st', type=float, default=0.69)
    parser.add_argument('--thresh_1', type=float, default=0.8)
    parser.add_argument('--thresh_2', type=float, default=0.5)
    parser.add_argument('--thresh_3', type=float, default=0.8)
...
def main(exp, args, num_gpu):
    ...
    # start evaluate
    *_, summary = evaluator.evaluate_stram(
