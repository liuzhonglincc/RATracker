...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--data_dir', type=str, default='/media/disk2/lzl/iccv_abalation/FairMOT-master/dataset')
    ...
    self.parser.add_argument('--merger_dropout', type=float, default=0.0)
    self.parser.add_argument('--weight_1', type=float, default=0.0)
    self.parser.add_argument('--thresh_1', type=float, default=0.4)
    self.parser.add_argument('--weight_2', type=float, default=0.0)
    self.parser.add_argument('--thresh_2', type=float, default=0.5)
    self.parser.add_argument('--weight_3', type=float, default=0.0)
    self.parser.add_argument('--thresh_3', type=float, default=0.7)
    self.parser.add_argument('--mark_ration', type=float, default=0.2)
    self.parser.add_argument('--hidden_dim', type=int, default=256)
    self.parser.add_argument('--d_model', type=int, default=128)

    self.parser.add_argument('--weight_s', type=float, default=0.4)
    self.parser.add_argument('--weight_t', type=float, default=0.3)
    self.parser.add_argument('--weight_st', type=float, default=0.5)
