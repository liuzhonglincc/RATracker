...
def eval_seq(opt, dataloader, data_type, result_filename,seq,save_dir=None, show_image=True, frame_rate=30):
    ...
    for path, img, img0,frame_id_start in dataloader:
        ...
        online_targets = tracker.update_stram(blob, img0, seq,save_dir, model_stram)
        online_tlwhs = []
        online_ids = []
...
if __name__ == '__main__':
    ...
    parser.add_argument('--nms_thres', type=float, default=0.54, help='iou thresh for nms')
    parser.add_argument('--track_buffer', type=int, default=37, help='tracking buffer')
    ...
    parser.add_argument('--thresh_1', type=float, default=0.48)
    parser.add_argument('--thresh_2', type=float, default=0.6)
