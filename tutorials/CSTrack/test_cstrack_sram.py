...
def eval_seq(opt, dataloader, data_type, result_filename,seq,save_dir=None, show_image=True, frame_rate=30):
    ...
    for path, img, img0,frame_id_start in dataloader:
        ...
        online_targets = tracker.update_sram(blob, img0, seq,save_dir, model_sram)
        online_tlwhs = []
        online_ids = []
...
if __name__ == '__main__':
    ...
    parser.add_argument('--conf_thres', type=float, default=0.54, help='object confidence threshold')
    ...
    parser.add_argument('--weight_1', type=float, default=0.05)
    parser.add_argument('--thresh_1', type=float, default=0.4)
    parser.add_argument('--thresh_2', type=float, default=0.45)
    parser.add_argument('--thresh_3', type=float, default=0.75)
