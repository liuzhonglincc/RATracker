...
def eval_seq(opt, dataloader, data_type, result_filename, save_dir=None, show_image=True, frame_rate=30, seq=None):
    '''
    ...
    for i, (path, img, img0) in enumerate(dataloader):
        ...
        online_targets = tracker.update_stram(blob, img0, model_stram)
        ...
        for t in online_targets:
            ...
            if tlwh[2] * tlwh[3] > opt.min_box_area and not vertical:
                ...
                online_features.append(t.curr_feat)
        timer.toc()
        # save results
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/mix_mot17_half_jde.pt', help='path to weights file')
    parser.add_argument('--iou-thres', type=float, default=0.5, help='iou threshold required to qualify as detected')
    parser.add_argument('--conf-thres', type=float, default=0.71, help='object confidence threshold')
    parser.add_argument('--nms-thres', type=float, default=0.41, help='iou threshold for non-maximum suppression')
    parser.add_argument('--min-box-area', type=float, default=200, help='filter out tiny boxes')
    parser.add_argument('--track-buffer', type=int, default=40, help='tracking buffer')
    ...
    parser.add_argument('--weight_s', type=float, default=0.28)
    parser.add_argument('--weight_t', type=float, default=0.28)
    parser.add_argument('--weight_st', type=float, default=0.65)
    parser.add_argument('--thresh_1', type=float, default=0.75)

    parser.add_argument('--thresh_2', type=float, default=0.56)
    ...
    if not opt.test_mot16:
        ...
        seqs_str = '''MOT16-01
                     ...
                     MOT16-12
                     MOT16-14'''
        data_root = 'datasets/MOT/MOT16/images/test'
