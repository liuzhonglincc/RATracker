...
def eval_seq(opt, dataloader, data_type, result_filename, save_dir=None, show_image=True, frame_rate=30):
    ...
    for i, (path, img, img0) in enumerate(dataloader):
        ...
        online_targets = tracker.update_sram(blob, img0, model_sram)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--thresh_2', type=float, default=0.2)
    parser.add_argument('--weight_3', type=float, default=0.3)
    parser.add_argument('--thresh_3', type=float, default=0.9)
