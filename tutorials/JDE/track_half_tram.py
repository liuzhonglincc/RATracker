...
def eval_seq(opt, dataloader, data_type, result_filename, save_dir=None, show_image=True, frame_rate=30):
    ...
    for i, (path, img, img0) in enumerate(dataloader):
        ...
        online_targets = tracker.update_tram(blob, img0, model_tram_1, model_tram_2, model_tram_3)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight_1', type=float, default=0.8)
    parser.add_argument('--thresh_1', type=float, default=0.3)
    parser.add_argument('--weight_2', type=float, default=0.2)
    parser.add_argument('--thresh_2', type=float, default=0.5)
    parser.add_argument('--weight_3', type=float, default=0.1)
    parser.add_argument('--thresh_3', type=float, default=0.7)
