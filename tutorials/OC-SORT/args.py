...
def make_parser():
    ...
    parser.add_argument('--weight_1', type=float, default=0.2)
    parser.add_argument('--weight_s', type=float, default=0.5)
    parser.add_argument('--weight_t', type=float, default=0.5)
    parser.add_argument('--weight_st', type=float, default=0.2)
