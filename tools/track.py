...
def make_parser():
    parser = argparse.ArgumentParser("RATrack ...")
    ...
    parser.add_argument("--metric", type=str, default="iou", help=' ')
...
def image_track(predictor, vis_folder, args):
    ...
    # Tracker
    tracker = ByteTrack(args, frame_rate=args.fps)
    results = []
...
if __name__ == "__main__":
    ...
    if args.split_to_eval == 'val':
        accs = []
        seqs = ["MOT17-02-FRCNN", "MOT17-04-FRCNN", "MOT17-05-FRCNN", "MOT17-09-FRCNN", "MOT17-10-FRCNN", "MOT17-11-FRCNN", "MOT17-13-FRCNN"]
        for seq_num in seqs:
            accs.append(eval_seq(seq_num, "datasets/MOT17/train", "YOLOX_outputs/yolox_x_ablation/track_results"))
